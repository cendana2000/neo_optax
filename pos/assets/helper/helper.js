var HELPER = (function () {
  ...
  return {
    ...
    loadPage: function (el) {
      ...
      var me = $(el);
      var page = $(el).data();
      if ($("a.link").attr("href") !== "javascript:void(0)") {
        $.ajax({
    ...
    get_role_access: function (name = null) {
      if (name) {
        if (role_access) {
          if (typeof role_access === "object") {
            role_access = Object.values(role_access);
          }
