...
<head>
	...
	<link href="assets/plugins/custom/bootstrap-fileinput-master/css/fileinput.min.css" rel="stylesheet" type="text/css" />
	<link href="assets/plugins/custom/bootstrap-fileinput-master/themes/explorer-fas/theme.min.css" rel="stylesheet" type="text/css" />
	...
	<link rel="stylesheet" href="assets/plugins/custom/bootstrap-star-rating/css/star-rating.css" />
	<link rel="stylesheet" href="assets/plugins/custom/bootstrap-star-rating/themes/krajee-fas/theme.css" />
	<link rel="stylesheet" href="assets/plugins/custom/bootstrap-colorpicker/package/dist/css/bootstrap-colorpicker.css" />
	<link rel="stylesheet" href="assets/leaflet/leaflet.css" />
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.css" />
	<link rel="stylesheet" href="assets/leaflet/leaflet.fullscreen/Control.FullScreen.css" />
	...
	<!--end::Layout Themes-->
	<link rel="shortcut icon" href="assets/media/logos/favicon-timah.ico" />
</head>
<!--end::Head-->
<!--begin::Body-->

<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading scrollbar">
	<!--begin::Main-->
	<!--begin::Header Mobile-->
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		...
		<a href="index.html">
			...
			<span style="color: #FFF;font-size: 16px;text-transform: uppercase;"><?php echo $data['data'][0]['company_aplikasi_nama'] ?></span>
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
		<div class="d-flex align-items-center">
			...
			<button style="display: none;" class="btn p-0 burger-icon ml-4" id="kt_header_mobile_toggle">
				<span></span>
			</button>
	...
	<!--end::Header Mobile-->
	<div class="d-flex flex-column flex-root" id="all_body">
		<!--begin::Page-->
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
				...
				<div class="brand flex-column-auto" id="kt_brand">
					...
					<a href="/" class="brand-logo">
						<span style="color: #FFF;font-size: 19px;text-transform: uppercase;">PROFIL IMAGE STUDIO</span>
					</a>
					<!--end::Logo-->
					<!--begin::Toggle-->
					<button style="" class="brand-toggle btn btn-sm px-0" id="kt_aside_toggle">
				...
				<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
					<div class="col-12 mt-5">
						<div class="input-icon input-icon-right">
							<input type="text" name="cari" placeholder="Cari Menu" id="cari-menu-sidebar" class="form-control" autocomplete="off">
							<span>
					...
					<div id="kt_aside_menu" class="aside-menu mt-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="margin-bottom: 80px;">
						<!--begin::Menu Nav-->
						<ul class="menu-nav side-nemu pt-0">
							<?= $menu ?>
						</ul>
						<!--end::Menu Nav-->
					</div>
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div id="kt_header" class="header header-fixed">
					<!--begin::Container-->
					<div class="container-fluid d-flex align-items-stretch justify-content-between" style="background-color: #1a1a27;background-size: cover;box-shadow: 0px 0px 5px 0px;">
						<!--begin::Header Menu Wrapper-->
						<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
							<!--begin::Header Menu-->
							<div style="display: none;" id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
								<!--begin::Header Nav-->
								<ul class="menu-nav side-nemu">
						...
						<div class="topbar">
							...
							<div class="dropdown">
								...
								<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
									<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" title="Download Manual Book">
								...
								<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
									...
									<ul class="navi navi-hover py-4">
										<!--begin::Item-->
										<li class="navi-item">
											<a href="<?= base_url() ?>/dokumen/manbook/manual-book-web.pdf" target="_blank" class="navi-link">
												<span class="symbol symbol-20 mr-3">
													<i class="fa fa-download"></i>
												</span>
												<span class="navi-text">Manual Book</span>
											</a>
										</li>
										<!--end::Item-->
									</ul>
							...
							<div class="dropdown">
								<!--begin::Toggle-->
								<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
									<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" title="Download APK">
								...
								<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
									...
									<ul class="navi navi-hover py-4">
										<!--begin::Item-->
										<li class="navi-item">
											<a href="https://play.google.com/store/apps/details?id=id.co.pttimah.fms.user" class="navi-link">
												<span class="symbol symbol-20 mr-3">
													<img src="assets/media/svg/bg/ic-user.svg" alt="" />
												</span>
										...
										<li class="navi-item active">
											<a href="https://play.google.com/store/apps/details?id=id.co.pttimah.fms.driver" class="navi-link">
												<span class="symbol symbol-20 mr-3">
													<img src="assets/media/svg/bg/ic-driver.png" alt="" />
												</span>
												<span class="navi-text">Driver</span>
											</a>
										</li>
										<!--end::Item-->
									</ul>
									...
									<form>
										...
										<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
											...
											<h4 class="d-flex flex-center rounded-top">
												...
												<span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2 span-new-notif" style="display: none;">0 new</span>
											</h4>
											<!--end::Title-->
											<!--begin::Tabs-->
											<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
												<li class="nav-item">
													<a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">Notif</a>
												</li>
											</ul>
											<!--end::Tabs-->
										</div>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
												<!--begin::Scroll-->
												<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200" id="div-notification">
													<!--begin::Item-->
												...
												<div class="d-flex flex-center pt-7">
													<a href="javascript:void(0)" class="btn btn-light-primary font-weight-bold text-center" id="btn-notification-more" style="display: none;">Lihat Lainnya</a>
												</div>
												<!--end::Action-->
											</div>
											<!--end::Tabpane-->
							...
							<div class="dropdown">
								...
								<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo $this->session->userdata("user_nama"); ?></span>
										<span class="symbol symbol-35 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold"><?php echo substr($this->session->userdata('user_nama'), 0, 1)  ?></span>
										</span>
									</div>
								</div>
								<!--end::Toggle-->
								...
								<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
									...
									<ul class="navi navi-hover py-4">
										...
										<li class="navi-item">
											<a href="javascript:void(0)" onclick="doLogout()" class="navi-link">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="
						...
						/*background-image: url('assets/media/bg/bg-content2.jpg');*/
						">
					...
					<div class="content d-flex flex-column flex-column-fluid pt-0" id="kt_content">
						<div class="d-flex flex-column-fluid">
							<div class="container" id="content_data" style="margin:0;max-width:none">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="d-flex align-items-center mt-5">
				<div class="symbol symbol-100 mr-5">
					<div class="symbol-label" style="background-image:url('dokumen/user/<?php echo $this->session->userdata("user_foto"); ?>')"></div>
					<i class="symbol-badge bg-success"></i>
				</div>
				<div class="d-flex flex-column">
					<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php echo $this->session->userdata("user_nama"); ?></a>
					<div class="text-muted mt-1"><?php echo ($this->session->userdata("hak_akses_nama")); ?></div>
					<div class="navi mt-2">
						<a href="#" class="navi-item">
							<span class="navi-link p-0 pb-2">
								...
								<span class="navi-text text-muted text-hover-primary"><?php echo $this->session->userdata("user_email"); ?></span>
							</span>
						</a>
						<a href="javascript:void(0);" onclick="onModalEditProfile();" class="btn btn-sm btn-light-success font-weight-bolder py-2 px-5">Edit Profile</a>
						<a href="javascript:void(0);" onclick="doLogout()" class="btn btn-sm btn-light-danger font-weight-bolder py-2 px-5">Sign Out</a>
					</div>
				</div>
			</div>
			<!--end::Header-->
	...
	<script src="assets/js/pages/id_ID_FormValidation.js"></script>
	...
	<script src="assets/plugins/custom/bootstrap-fileinput-master/js/fileinput.min.js"></script>
	<script src="assets/plugins/custom/bootstrap-fileinput-master/js/plugins/piexif.js"></script>
	<script src="assets/plugins/custom/bootstrap-fileinput-master/js/plugins/sortable.js"></script>
	<script src="assets/plugins/custom/bootstrap-fileinput-master/js/locales/id.js"></script>
	<script src="assets/plugins/custom/bootstrap-fileinput-master/themes/fas/theme.js"></script>
	<script src="assets/plugins/custom/bootstrap-fileinput-master/themes/explorer-fas/theme.min.js"></script>
	<script src="assets/plugins/custom/lightbox2/lightbox.js"></script>
	<!--end::Page Vendors-->
	<!--begin::Page Scripts(used by this page)-->
	<script src="assets/js/pages/crud/datatables/advanced/column-rendering.js?v=7.0.5"></script>
	...
	<script src="assets/plugins/custom/bootstrap-star-rating/js/star-rating.js"></script>
	<script src="assets/plugins/custom/bootstrap-star-rating/themes/krajee-fas/theme.js"></script>
	<script src="assets/plugins/custom/bootstrap-colorpicker/package/dist/js/bootstrap-colorpicker.js"></script>
	<script src="assets/leaflet/leaflet.js"></script>
	<script src="assets/leaflet/AnimatedMarker.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.js"></script>
	<script src="assets/leaflet/leaflet.fullscreen/Control.FullScreen.js"></script>
	<script src="assets/plugins/custom/moment/moment-with-locale.js"></script>
	<!--end::Page Vendors-->
	<!--begin::Page Scripts(used by this page)-->
	<script src="assets/js/pages/widgets.js?v=7.0.5"></script>
	<script src="https://www.gstatic.com/firebasejs/7.2.0/firebase-app.js"></script>
	<script src="https://www.gstatic.com/firebasejs/7.2.0/firebase-messaging.js"></script>
	<script src="<?php echo base_url(); ?>assets/helper/helper.js?v=1.0.14"></script>
...
<script type="text/javascript">
	HELPER.createCombo({
		...
		url: BASE_URL + 'HakAkses/combobox',
		withNull: true,
		grouped: false,
		chosen: true,
		callback: function() {}
	...
	HELPER.createCombo({
		...
		displayField: 'region_nama',
		url: BASE_URL + 'Region/combobox',
		withNull: true,
		grouped: false,
		chosen: true,
		callback: function() {}
	...
	$(function() {
		...
		$(document).on('click', '.side-nemu a', function() {

			var me = $(this),

				pageUrl = me.data('page');
			if (pageUrl == "" || pageUrl == null || pageUrl == 'undefined') {
				...
				$.ajax({
					...
					success: function(res) {
						...
						$.each($('[data-roleable=true]', $('#content_data')), function(i, v) {
			...
			clearInterval(window.realtime_location);
		});
	...
	function onModalEditProfile(user_id) {
		$.ajax({
			...
			success: function(response) {
				...
				HELPER.populateForm($('#form-edit-profile'), response);

				var img = './assets/media/noimage.png';
				if (response.user_foto) {
					img = './dokumen/user/thumbs/' + response.user_foto;
				}
				$('#user_foto').attr('src', img);

				if (response.user_foto) {
					img = response.user_foto;
					var img_link = './dokumen/user/';
					var initialPreview = [];
					var initialPreviewConfig = [];
					initialPreview.push(img_link + img);
					initialPreviewConfig.push({
						key: 1
					});
					$('#user_foto').fileinput('destroy');
					$('#user_foto').fileinput({
						theme: 'fas',
						uploadUrl: '',
						uploadAsync: true,
				...
				HELPER.createCombo({
					...
					displayField: 'hak_akses_nama',
					selected: {
						id: response.user_hak_akses,
						name: response.hak_akses_nama
					}
				});
	...
	function save_profile(name) {
		...
		formData.append("refresh_session", 1);
		HELPER.save({
			cache: false,
			data: formData,
			contentType: false,
	...
	function cek_ulangi_password(val) {
		var pass = $('[name=password_new]').val();
		if (val == pass) {
			document.getElementById('u_sep').removeAttribute('style');
			$('.btn-edit-profile').removeAttr('disabled');
			$("#u_pass").attr('class', 'form-group has-success');
			$("#u_eep").attr('style', 'display: none;');
		} else {
			document.getElementById('u_eep').removeAttribute('style');
			$("#u_pass").attr('class', 'form-group has-error');
			$("#u_sep").attr('style', 'display: none;');
			$(".btn-edit-profile").attr('disabled', 'disabled');
		}
	}

	function onPasswordNew(val) {
		if (val) {
			$('[name=password_new]').attr('required', 'required');
			$('[name=password_repeat]').attr('required', 'required');

			$('#password_new_label').html('* Password Baru');
			$('#password_repeat_label').html('* Password Ulangi');
		} else {
			$('[name=password_repeat]').val('');

			$('[name=password_new]')[0].removeAttribute('required');
			$('[name=password_repeat]')[0].removeAttribute('required');
	...
	function loadNotification() {
		...
		HELPER.initLoadMore({
			perPage: 10,
			urlExist: BASE_URL + 'Dashboard/notifikasiExist',
			urlMore: BASE_URL + 'Dashboard/notifikasiMore',
			callbackExist: function(data) {
				if (data.hasOwnProperty('success')) {
					$('#div-notification').html(`<div class="col-12 d-flex text-center">
	                                                <h3>Tidak ada notifikasi.</h3>
	                                            </div>`)
					$('#btn-notification-more').hide()
				} else {
					$('#btn-notification-more').show('slow')
				}
			},
			callbackMore: function(data) {
				...
				myQueue.enqueue(function(next) {
					...
					$.each(data_notifikasi.data, function(i, v) {
						var date = moment(v.notifikasi_tanggal).locale('id').format('dddd, D MMMM YYYY')
						var show_title = HELPER.text_truncate(v.notifikasi_title);
						var unread = '';
						if (v.notifikasi_read_status == null || parseInt(v.notifikasi_read_status) == 0) {
							unread = `<i class="fa fa-circle top-5 font-10 unread unread-${v.notifikasi_id}"></i>`
						}
						$('#div-notification').append(`
							<div class="d-flex align-items-center mb-6">
								...
								<!--begin::Text-->
								<div class="d-flex flex-column font-weight-bold">
									<span class="text-dark text-hover-primary mb-1 font-size-lg">${show_title}</span>
									<span class="text-muted">${v.notifikasi_keterangan}</span>
								</div>
								<!--end::Text-->
							</div>
						`)
			...
			scrollCek: function(callLoadMore) {
				$('#btn-notification-more').off('click');
				$('#btn-notification-more').on('click', function(e) {
					callLoadMore()
				});
			},
	...
	function setLoadNotification() {
		HELPER.ajax({
			url: BASE_URL + 'Dashboard/countData',
			complete: function(res) {
				if (res.success) {

					if (res.data.totalReqLupaPassword > 0) {
						$('.menu-label-SettingParent').html('<span class="label label-rounded label-primary">' + res.data.totalReqLupaPassword + '</span>')
						$('.menu-label-LupaPassword').html('<span class="label label-rounded label-primary">' + res.data.totalReqLupaPassword + '</span>')
					} else {
						$('.menu-label-SettingParent').html('')
						$('.menu-label-LupaPassword').html('')
					}

					if (res.data.totalOrderBaru > 0) {
						$('.menu-label-OrderTracking').html('<span class="label label-rounded label-primary">' + res.data.totalOrderBaru + '</span>')
						$('.menu-label-ApprovalOrder').html('<span class="label label-rounded label-primary">' + res.data.totalOrderBaru + '</span>')
					} else {
						$('.menu-label-OrderTracking').html('')
						$('.menu-label-ApprovalOrder').html('')
					}

					if (res.data.totalReqBbmBaru > 0) {
						$('.menu-label-FuelUsageTracking').html('<span class="label label-rounded label-primary">' + res.data.totalReqBbmBaru + '</span>')
						$('.menu-label-IsiBbm').html('<span class="label label-rounded label-primary">' + res.data.totalReqBbmBaru + '</span>')
					} else {
						$('.menu-label-FuelUsageTracking').html('')
						$('.menu-label-IsiBbm').html('')
					}

					if (res.data.totalReqCutiBaru > 0) {
						$('.menu-label-CutiParent').html('<span class="label label-rounded label-primary">' + res.data.totalReqCutiBaru + '</span>')
						$('.menu-label-Cuti').html('<span class="label label-rounded label-primary">' + res.data.totalReqCutiBaru + '</span>')
					} else {
						$('.menu-label-CutiParent').html('')
						$('.menu-label-Cuti').html('')
					}

					if (res.data.totalReqLemburBaru > 0) {
						$('.menu-label-AbsensiParent').html('<span class="label label-rounded label-primary">' + res.data.totalReqLemburBaru + '</span>')
						$('.menu-label-Lembur').html('<span class="label label-rounded label-primary">' + res.data.totalReqLemburBaru + '</span>')
					} else {
						$('.menu-label-AbsensiParent').html('')
						$('.menu-label-Lembur').html('')
					}

					if (res.data.totalReqServisInspeksiBaru > 0 || res.data.totalReqServisOnDemandBaru > 0) {
						if (res.data.totalReqServisInspeksiBaru > 0 && res.data.totalReqServisOnDemandBaru > 0) {
							var total = res.data.totalReqServisInspeksiBaru + res.data.totalReqServisOnDemandBaru;
							$('.menu-label-ServicesAndMaintenance').html('<span class="label label-rounded label-primary">' + total + '</span>')
							$('.menu-label-ServiceInspeksi').html('<span class="label label-rounded label-primary">' + res.data.totalReqServisInspeksiBaru + '</span>')
							$('.menu-label-ServiceOndemand').html('<span class="label label-rounded label-primary">' + res.data.totalReqServisOnDemandBaru + '</span>')
						} else if (res.data.totalReqServisInspeksiBaru > 0 && res.data.totalReqServisOnDemandBaru == 0) {
							$('.menu-label-ServicesAndMaintenance').html('<span class="label label-rounded label-primary">' + res.data.totalReqServisInspeksiBaru + '</span>')
							$('.menu-label-ServiceInspeksi').html('<span class="label label-rounded label-primary">' + res.data.totalReqServisInspeksiBaru + '</span>')
							$('.menu-label-ServiceOndemand').html('')
						} else if (res.data.totalReqServisInspeksiBaru == 0 && res.data.totalReqServisOnDemandBaru > 0) {
							$('.menu-label-ServicesAndMaintenance').html('<span class="label label-rounded label-primary">' + res.data.totalReqServisOnDemandBaru + '</span>')
							$('.menu-label-ServiceOndemand').html('<span class="label label-rounded label-primary">' + res.data.totalReqServisOnDemandBaru + '</span>')
							$('.menu-label-ServiceInspeksi').html('')
						} else {
							$('.menu-label-ServicesAndMaintenance').html('')
							$('.menu-label-ServiceInspeksi').html('')
							$('.menu-label-ServiceOndemand').html('')
						}
					} else {
