                        ...
                        <div class="kt-section">
                            <div class="kt-section__content kt-section__content--border">
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" readonly style="background-color: #eaeaea;" placeholder="#AUTO" type="text" id="supplier_kode" name="supplier_kode">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-5">
                                        <input type="text" class="form-control" name="supplier_rekening" id="supplier_rekening">
                                    </div>
