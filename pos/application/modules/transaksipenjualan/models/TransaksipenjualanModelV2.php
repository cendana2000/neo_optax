...
class TransaksipenjualanModelV2 extends Base_Model
{
	...
	public function gen_kode_penjualan($value = false, $trans)
	{
		...
		return 'T' . $last_kode . $trans['penjualan_metode'] . date('ymd');
