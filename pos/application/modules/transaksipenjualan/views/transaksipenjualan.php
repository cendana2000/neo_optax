						...
						<tbody>
							<tr class="barang_1">
								<td scope="row">
									...
									<select class="form-control barang_id" name="penjualan_detail_barang_id[1]" id="penjualan_detail_barang_id_1" data-id="1" onchange="setSatuan('1')" style="width: 100%;white-space: nowrap"></select>
								</td>
								<td>
