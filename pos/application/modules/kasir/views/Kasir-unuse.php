									...
									<div class="card-body d-flex bg-white card-rounded flex-grow-1">
										<div class="form-group">
											...
											<div class="form-group row" id="divBayarBank">
												<label class="col-4 col-form-label">Bayar Bank</label>
												<div class="col-8">
													<input type="text" name="penjualan_total_bayar_bank" id="">
												</div>
											</div>
											<div class="form-group row" id="divBayarTunai">
												<label class="col-4 col-form-label">Bayar Tunai</label>
												<div class="col-8">
													<input type="text" name="penjualan_total_bayar_tunai" id="">
												</div>
											</div>
											<div class="form-group row" id="divJatuhTempo">
												<label class="col-4 col-form-label">Jatuh Tempo</label>
												<div class="col-8">
													<input type="text" name="penjualan_jatuh_tempo" id="">
												</div>
											</div>
											<div class="form-group row">
