		...
		<div class="card card-custom">
			<div class="card-header card-header-right ribbon ribbon-clip ribbon-left">
				<div class="ribbon-target" style="top: 12px;">
					<span class="ribbon-inner bg-primary"></span> DATA PEMBAYARAN HUTANG
				</div>
					...
					<div class="example-tools justify-content-center">
						<div class="kt-portlet__head-toolbar-wrapper">
							<div class="dropdown dropdown-inline">
								...
								<!-- <button type="button" class="btn btn-focus btn-sm btn-elevate btn-elevate-air" onclick="onPrint()">
									<i class="la la-print"></i> Kwitansi
								</button> -->
								<!-- <button type="button" class="btn btn-outline-focus btn-sm btn-elevate btn-elevate-air" onclick="onPrintTT()">
									<i class="la la-print"></i> Tanda Terima
								</button> -->
								<!-- <a href="#modal" data-toggle="modal">
									<button type="button" class="btn btn-outline-success btn-sm btn-icon"><i class="fa fa-calendar-day"></i></button>
								</a> -->
			...
			<div class="card-body table-responsive">
				<table class="table table-striped table-checkable table-condensed" id="table-pembayaran">
					<thead>
						<tr>
