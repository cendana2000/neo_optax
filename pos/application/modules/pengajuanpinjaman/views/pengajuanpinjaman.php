<div class="kt-portlet kt-portlet--mobile table_data">
	...
	<div class="kt-portlet__body">
		<!-- <div class="form-group row">
			<div class="col-9"></div>
			<div class="col-3">
				<input type="month" name="bulan" id="bulan" class="form-control" value="<?php echo date('Y-m')?>">
			</div>
		</div> -->
		<!--begin: Datatable -->
		<table class="table table-striped table-checkable table-condensed" id="table-pengajuan">
			<thead>
				<tr>
