		...
		<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid wizard" id="kt_login">
					...
					<div class="login-form">
						...
						<form class="form px-10" action="javascript:void(0)" novalidate="novalidate" id="kt_login_signin_form" autocomplete='off'>
							...
							<div class="d-flex justify-content-between pt-7">
								...
								<div>
									<a href="https://persada.malangkota.go.id/" title="Kembali ke https://persada.malangkota.go.id" class="btn btn-secondary btn-lg font-weight-bolder font-size-h6 px-4 py-4 btn-icon my-3"><i class="fa fa-home"></i></a>
			...
			<div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
				<div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom" style="background-image: url(<?= base_url(); ?>assets/media/svg/illustrations/login-visual-1.svg);">
					<!--begin::Aside title-->
					<h3 class="pt-lg-30 pl-lg-20 pb-lg-0 pl-10 pt-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-lg text-white">Login Kasir</h3>
					...
					<div class="my-lg-5 mx-10 mx-lg-20">
						...
						<button style="vertical-align: middle;" onclick="downloadMB('Manual_Book_POS_26_Nov_2021.pdf')" class="btn btn-light-primary btn-sm font-weight-bold mr-2">POS <span class="fas fa-download fa-sm"></span></button>
