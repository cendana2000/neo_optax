								...
								<table class="table table-opname table-hover table-responsive tableBodyScroll" id="table-detail_barang">
									...
									<tbody>
										<tr class="barang_1">
											...
											<td><a href="javascript:;" data-id="1" class="btn btn-light-warning btn-sm" onclick="remRow(this)" title="Hapus">
...
<div class="card card-custom cetak_data" style="display: none">
	<div class="card-header card-header-right ribbon ribbon-clip ribbon-left">
		<div class="ribbon-target" style="top: 12px;">
			<span class="ribbon-inner bg-primary"></span> CETAK STOK OPNAME
		</div>
