...
<script type="text/javascript">
			...
			callback: function(res) {
				$.ajax({
                    ...
                    success : function(dt) {
                        ...
                        addBarang2(retur_barang);
						setSatuan2(dt.pembelian_detail_barang_id, retur_barang.retur_pembelian_detail_satuan, dt.pembelian_detail_id);
                        $('tr.no-list').remove();
                        $('#table-detail_barang tfoot tr').removeAttr('style');
                    }
                })				
	...
	function addBarang2(dt) {
		console.log(dt)
		id = dt.retur_pembelian_detail_detail_id;
		html = `<tr class="barang barang_`+id+`" data-id="`+id+`">
					<td scope="row">
						<input type="hidden" value="`+dt.retur_pembelian_detail_id+`" class="form-control" name="retur_pembelian_detail_id[`+id+`]" id="retur_pembelian_detail_id_`+id+`">						
						<input type="hidden" value="`+dt.retur_pembelian_detail_satuan_kode+`" class="form-control" name="retur_pembelian_detail_satuan_kode[`+id+`]" id="retur_pembelian_detail_satuan_kode_`+id+`">						
						<input type="hidden" value="`+dt.retur_pembelian_detail_detail_id+`" class="form-control" name="retur_pembelian_detail_detail_id[`+id+`]" id="retur_pembelian_detail_detail_id_`+id+`">				
						<input type="hidden" value="`+dt.retur_pembelian_detail_barang_id+`" data-satuan_beli="`+dt.pembelian_detail_satuan+`" data-konversi="`+dt.barang_satuan_konversi+`" data-qty="`+dt.pembelian_detail_qty+`" data-qty_barang="`+dt.pembelian_detail_qty_barang+`" data-harga="`+dt.pembelian_detail_harga+`" data-harga_barang="`+dt.pembelian_detail_harga_barang+`"  class="form-control" name="retur_pembelian_detail_barang_id[`+id+`]" id="retur_pembelian_detail_barang_id_`+id+`">	
						<input class="form-control" type="text" value="`+dt.barang_kode+` - `+dt.barang_nama+`" name="barang_nama[]" id="barang_nama_`+id+`" disabled="">					
					</td>
					<td><select class="form-control" name="retur_pembelian_detail_satuan[`+id+`]" id="retur_pembelian_detail_satuan_`+id+`" onchange="getHarga('`+id+`')"></select></td>
					<td><input class="form-control number" value="`+dt.retur_pembelian_detail_harga+`" type="text" readonly="" name="retur_pembelian_detail_harga[`+id+`]" id="retur_pembelian_detail_harga_`+id+`" onkeyup="countRow('`+id+`')"></td>
					<td><input class="form-control number" type="text" disabled="" value="`+dt.retur_pembelian_detail_qty+`" name="retur_pembelian_detail_qty[`+id+`]" id="retur_pembelian_detail_qty_`+id+`" onkeyup="countRow('`+id+`')"></td>
					<td>
						<input class="form-control number qty" type="text" name="retur_pembelian_detail_retur_qty[`+id+`]" id="retur_pembelian_detail_retur_qty_`+id+`" value="`+dt.retur_pembelian_detail_retur_qty+`" onkeyup="countRow('`+id+`')">
						<input class="form-control number" type="hidden" value="`+dt.retur_pembelian_detail_retur_qty_barang+`" name="retur_pembelian_detail_retur_qty_barang[`+id+`]" id="retur_pembelian_detail_retur_qty_barang_`+id+`">
					</td>
					<td><input class="form-control number" readonly="" type="text" name="retur_pembelian_detail_sisa_qty[`+id+`]" id="retur_pembelian_detail_sisa_qty_`+id+`" value="`+dt.retur_pembelian_detail_sisa_qty+`"></td>
					<td><input class="form-control number jumlah" type="text" name="retur_pembelian_detail_jumlah[`+id+`]" id="retur_pembelian_detail_jumlah_`+id+`"  value="`+dt.retur_pembelian_detail_jumlah+`" readonly=""></td>
					<td><button type="button" data-id="`+id+`" class="btn btn-sm btn-clean btn-icon btn-icon-md kt-font-bold kt-font-warning" title="Edit" onclick="remRow('`+id+`')" >                      
	...
	function addBarang() {
		...
		html = `<tr class="barang barang_`+row+`" data-id="`+row+`">
					...
					<td><input class="form-control number jumlah" type="text" name="retur_pembelian_detail_jumlah[`+row+`]" id="retur_pembelian_detail_jumlah_`+row+`"  value="" readonly=""></td>
