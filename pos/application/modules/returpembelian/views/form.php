		...
		<div class="card card-custom">
			...
			<form class="kt-form" action="javascript:save('form-returpembelianbarang')" name="form-returpembelianbarang" id="form-returpembelianbarang">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-3">
							<div class="input-group date">
								<input class="form-control" type="text" id="retur_pembelian_tanggal" name="retur_pembelian_tanggal" readonly value="<?php echo date('d/m/Y') ?>" />
						...
						<div class="col-md-4">
							<input class="form-control" readonly type="text" id="retur_pembelian_kode" name="retur_pembelian_kode" style="background-color: #eaeaea;" placeholder="##.AUTO">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-3">
							<div class="input-group">
								<input class="form-control" type="text" id="pembelian_tanggal" name="pembelian_tanggal" disabled placeholder="dd/mm/yy">
								<div class="input-group-append">
									<span class="input-group-text">
										<i class="la la-calendar-check-o"></i>
									</span>
						...
						<div class="col-md-4">
							...
							<div class="input-group">
								<input class="form-control number" type="text" id="pembelian_bayar_grand_total" name="pembelian_bayar_grand_total" disabled="">
					...
					<div class="form-group row">
						<div class="col-md-4">
							<button type="button" id="button_daftar_beli" class="btn btn-sm btn-primary" onclick="listBarang()"><i class="flaticon-add"></i> Daftar Pembelian Barang</button>
							<button type="button" id="button_daftar_beli_edit" class="btn btn-sm btn-primary" onclick="listBarangEdit()"><i class="flaticon-add"></i> Daftar Pembelian Barang</button>
						</div>
					</div>
						...
						<table class="table table-bordered table-hover" id="table-detail_barang">
							...
							<tbody>
								<tr class="barang barang_1" data-id="1">
									...
									<td>
										<button type="button" data-id="1" class="btn btn-light-danger btn-sm" id="remButtonAdd_1" title="Edit" onclick="remRow('1')">
							...
							<tfoot class="table-borderless">
								<tr>
									<td class="no-border text-right align-middle">Total Item</td>
									...
									<td class="no-border text-right align-middle" colspan="2">Total Retur</td>
									...
									<td class="no-border text-right align-middle">Total</td>
...
<div class="row cetak_data" style="display: none">
	<div class="col-md-12">
		<div class="card card-custom">
			<div class="card-header card-header-right ribbon ribbon-clip ribbon-left">
				<div class="ribbon-target" style="top: 12px;">
					<span class="ribbon-inner bg-primary"></span>CETAK RETUR PEMBELIAN
				</div>
