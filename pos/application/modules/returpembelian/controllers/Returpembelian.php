...
class Returpembelian extends Base_Controller
{
	...
	public function index()
	{
		...
		$this->response(
			$this->select_dt($var, 'returpembelian', 'table', false)
		);
	}
	...
	public function table_detail_barang()
	{
		...
		$pembelian = $this->transaksipembelian->read(array(
			'pembelian_id' => $var['beli']['pembelian_detail_parent']
		));

		if (intval($pembelian['pembelian_bayar_jumlah']) > 0) {
			$response = array(
				'iTotalRecords' => 0,
			...
			$where = [
				'pembelian_detail_parent' => $var['beli']['pembelian_detail_parent']
			];

			$response = $this->select_dt(varPost(), 'transaksipembeliandetail', 'table', true, $where);
		}
	...
	function read($value = '')
	{
		...
		if (isset($retur['retur_pembelian_id'])) {
			...
			foreach ($retur_detail['data'] as $key => $value) {
				...
				$stok = $value['pembelian_detail_qty'];
				$html .= '<tr class="barang barang_' . $row . '" data-id="' . $row . '" data-detailid="' . $value['retur_pembelian_detail_detail_id'] . '">
					<td scope="row">
						<input type="hidden" value="' . $value['retur_pembelian_detail_id'] . '" class="form-control" name="retur_pembelian_detail_id[' . $row . ']" id="retur_pembelian_detail_id_' . $row . '">	
						<input type="hidden" value="' . $value['retur_pembelian_detail_detail_id'] . '" class="form-control" name="retur_pembelian_detail_detail_id[' . $row . ']" id="retur_pembelian_detail_detail_id_' . $row . '">	
						<input type="hidden" value="' . $value['retur_pembelian_detail_barang_id'] . '" class="form-control" data-id="' . $row . '" readonly name="retur_pembelian_detail_barang_id[' . $row . ']" id="retur_pembelian_detail_barang_id_' . $row . '">
						<input type="hidden" name="row[]" value="' . $row . '">
						<input type="text" class="form-control" readonly id="barang_id_fake_' . $row . '" value="' . $value['barang_kode'] . ' - ' . $value['barang_nama'] . '">
					</td>
					...
					<td><input class="form-control number form-control-solid" type="text" readonly="" name="barang_stok[' . $row . ']" id="barang_stok_' . $row . '" onchange="countRow(' . $row . ')" value="' . $value['retur_pembelian_detail_qty'] . '"></td>
					<td>
						<input class="form-control number qty" type="text" name="retur_pembelian_detail_retur_qty[' . $row . ']" id="retur_pembelian_detail_retur_qty_' . $row . '" value="' . $value['retur_pembelian_detail_retur_qty'] . '" onkeyup="countRow(' . $row . ')" onchange="countRow(' . $row . ')">
					...
					<td><input class="form-control number form-control-solid" readonly="" type="text" name="retur_pembelian_detail_sisa_qty[' . $row . ']" id="retur_pembelian_detail_sisa_qty_' . $row . '" value="' . $value['retur_pembelian_detail_sisa_qty'] . '"></td>
					...
					<td><button type="button" data-id="' . $row . '" class="btn btn-light-warning btn-sm" title="Edit" onclick="preventEdit()" >                      
						<span class="la la-trash"></span>
					</button></td>
				</tr>';
			}
			$lrow = count($retur_detail['data']) + 1;
			$html .= '<tr class="barang barang_' . $lrow . '" data-id="' . $lrow . '">
				<td scope="row">
					<input type="hidden" value="" class="form-control" name="retur_pembelian_detail_id[' . $lrow . ']" id="retur_pembelian_detail_id_' . $lrow . '">
					<input type="hidden" value="" class="form-control" name="retur_pembelian_detail_detail_id[' . $lrow . ']" id="retur_pembelian_detail_detail_id_' . $lrow . '">
					<input type="hidden" class="form-control" readonly name="retur_pembelian_detail_barang_id[' . $lrow . ']" id="retur_pembelian_detail_barang_id_' . $lrow . '">
					<input type="hidden" name="row[]" value="' . $lrow . '">
					<input type="text" class="form-control" readonly id="barang_id_fake_' . $lrow . '">
				</td>
				<td>
					<input type="hidden" class="form-control" name="retur_pembelian_detail_satuan[' . $lrow . ']" id="retur_pembelian_detail_satuan_' . $lrow . '">
					<input type="text" class="form-control" name="retur_pembelian_detail_satuan_kode[' . $lrow . ']" id="retur_pembelian_detail_satuan_kode_' . $lrow . '" readonly="">
				</td>
				<td>
					<input class="form-control number" value="" type="text" name="retur_pembelian_detail_harga[' . $lrow . ']" id="retur_pembelian_detail_harga_' . $lrow . '" onkeyup="countRow(' . $lrow . ')">
				</td>
				<td><input class="form-control number form-control-solid" type="text" readonly="" value="" name="barang_stok[' . $lrow . ']" id="barang_stok_' . $lrow . '" onchange="countRow(' . $lrow . ')"><span id="detail_satuan_' . $lrow . '"></span></td>
				<td>
					<input class="form-control number qty" type="text" name="retur_pembelian_detail_retur_qty[' . $lrow . ']" id="retur_pembelian_detail_retur_qty_' . $lrow . '" value="" onkeyup="countRow(' . $lrow . ')" onchange="countRow(' . $lrow . ')">
					<input class="form-control number" type="hidden" value="" name="retur_pembelian_detail_retur_qty_barang[' . $lrow . ']" id="retur_pembelian_detail_retur_qty_barang_' . $lrow . '">
				</td>
				<td><input class="form-control number form-control-solid" readonly type="text" name="retur_pembelian_detail_sisa_qty[' . $lrow . ']" id="retur_pembelian_detail_sisa_qty_' . $lrow . '" value=""></td>
				<td><input class="form-control number jumlah" type="text" name="retur_pembelian_detail_jumlah[' . $lrow . ']" readonly id="retur_pembelian_detail_jumlah_' . $lrow . '" value="" onchange="countJumlah()"></td>
				<td><button type="button" data-id="' . $lrow . '" class="btn btn-light-warning btn-sm" title="Edit" onclick="preventEdit()">
						<span class="la la-trash"></span>
					</button></td>
			</tr>';
		}
	...
	public function store()
	{
		...
		// Change string to date retur_pembelian_tanggal
		$retur_pembelian_tanggal = str_replace('/', '-', $data['retur_pembelian_tanggal']);
		$data['retur_pembelian_tanggal'] = date("Y-m-d H:i:s", strtotime($retur_pembelian_tanggal));
		...
		$up_beli = $this->db->where('pembelian_id', $data['retur_pembelian_pembelian_id'])
			...
			->set('pembelian_bayar_sisa', 'pembelian_bayar_sisa - ' . $data['retur_pembelian_total'], false)
			->set('pembelian_updated', date('Y-m-d H:i:s'))
			->update('pos_pembelian_barang');

		foreach ($data['retur_pembelian_detail_detail_id'] as $key => $val) {
			if ($key < count($data['retur_pembelian_detail_detail_id'])) {
				$this->db->query("UPDATE pos_pembelian_barang_detail SET pembelian_detail_retur_qty = COALESCE(pembelian_detail_retur_qty, 0) + " . $data['retur_pembelian_detail_retur_qty'][$key] . " WHERE pembelian_detail_id = '$val'");
			}
		}
		...
		$operation = $this->returpembelian->insert(gen_uuid($this->returpembelian->get_table()), $data, function ($res) use ($data) {
			...
			foreach ($data['retur_pembelian_detail_barang_id'] as $key => $value) {
				if ($key < count($data['retur_pembelian_detail_barang_id'])) {
					$detail = [
						...
						'retur_pembelian_detail_detail_id' => $data['retur_pembelian_detail_detail_id'][$key],
						...
						'retur_pembelian_detail_qty' => $data['barang_stok'][$key],
						'retur_pembelian_detail_qty_barang' => $data['barang_stok'][$key],
						...
						'retur_pembelian_detail_sisa_qty_barang' 		=> $data['retur_pembelian_detail_sisa_qty'][$key],
					...
					$kartu = $this->stokkartu->insert_kartu($kartu_data, 'RB');
	...
	public function update()
	{
		...
		// Change string to date retur_pembelian_tanggal
		$retur_pembelian_tanggal = str_replace('/', '-', $data['retur_pembeli	an_tanggal']);
		$data['retur_pembelian_tanggal'] = date("Y-m-d H:i:s", strtotime($retur_pembelian_tanggal));

		$returpembelian = $this->db->query("SELECT * FROM pos_retur_pembelian_barang prpb 
		LEFT JOIN pos_pembelian_barang ppb ON prpb.retur_pembelian_pembelian_id = ppb.pembelian_id 
		WHERE retur_pembelian_id = '" . $data['retur_pembelian_id'] . "'")->row_array();

		$realgrand = $returpembelian['pembelian_bayar_grand_total'] + $returpembelian['pembelian_retur'];
		$newgrand = $realgrand - $data['retur_pembelian_total'];

		$up_beli = $this->db->where('pembelian_id', $returpembelian['retur_pembelian_pembelian_id'])
			->set('pembelian_retur', $data['retur_pembelian_total'], false)
			->set('pembelian_bayar_sisa', $newgrand, false)
			->set('pembelian_updated', date('Y-m-d H:i:s'))
			->update('pos_pembelian_barang');
		...
		foreach ($data['retur_pembelian_detail_detail_id'] as $key => $val) {
			if ($key < count($data['retur_pembelian_detail_detail_id'])) {
				...
				// 	'pembelian_detail_retur_qty' => $data['retur_pembelian_detail_retur_qty'][$key],
				// );
				// $this->transaksipembeliandetail->update($val, $datapembeliandetail);

				$dctReturDetail = $this->db->get_where('v_pos_retur_pembelian_barang_detail', ['retur_pembelian_detail_id' => $data['retur_pembelian_detail_id'][$key]])->row_array();

				$this->db->query("UPDATE pos_pembelian_barang_detail SET pembelian_detail_retur_qty = COALESCE(pembelian_detail_retur_qty, 0) - " . $dctReturDetail['retur_pembelian_detail_retur_qty'] . " + " . $data['retur_pembelian_detail_retur_qty'][$key] . " WHERE pembelian_detail_id = '$val'");
			}
		}
	...
	public function destroy()
	{
		...
		$returpembelian = $this->db->query("SELECT * FROM pos_retur_pembelian_barang prpb 
		LEFT JOIN pos_pembelian_barang ppb ON prpb.retur_pembelian_pembelian_id = ppb.pembelian_id 
		WHERE retur_pembelian_id = '" . $data['retur_penjualan_id'] . "'")->row_array();

		// print_r('<pre>');print_r($returpembelian);print_r('</pre>');exit;

		$up_beli = $this->db->where('pembelian_id', $returpembelian['retur_pembelian_pembelian_id'])
			->set('pembelian_retur', 'pembelian_retur - ' . $returpembelian['pembelian_retur'], false)
			->set('pembelian_total', 'pembelian_total + ' . $returpembelian['pembelian_retur'], false)
			->set('pembelian_bayar_grand_total', 'pembelian_bayar_grand_total + ' . $returpembelian['pembelian_retur'], false)
			->set('pembelian_bayar_sisa', 'pembelian_bayar_sisa + ' . $returpembelian['pembelian_retur'], false)
			->set('pembelian_updated', date('Y-m-d H:i:s'))
			->update('pos_pembelian_barang');

		// $datapembeliandetail = array(
		// 	'pembelian_detail_retur_qty' => 0,
		// );
		// $this->transaksipembeliandetail->update(array(
		// 	'pembelian_detail_parent' => $returpembelian['retur_pembelian_pembelian_id']
		// ), $datapembeliandetail);
		$this->db->where('pembelian_detail_parent', $returpembelian['retur_pembelian_pembelian_id'])
			->set('pembelian_detail_retur_qty', 'pembelian_detail_retur_qty - ' . $returpembelian['retur_pembelian_jumlah_qty'], false)
			->update('pos_pembelian_barang_detail');

		// print_r($up_beli);
		// die();

		$operation = $this->returpembelian->delete(varPost('retur_penjualan_id', varExist($data, $this->returpembelian->get_primary(true))));

		$last_detail = $this->returpembeliandetail->select(array('filters_static' => array('retur_pembelian_detail_parent' => $data['retur_penjualan_id']), 'sort_static' => 'retur_pembelian_detail_order asc'))['data'];
		$delete = $last_detail;
		...
		$operation = $this->returpembeliandetail->delete(array('retur_pembelian_detail_parent' => $data['retur_penjualan_id']));
		$this->response($operation);
	}
	...
	public function cetak($value = '')
	{
		if ($value) {
			...
			$html .= '<table style="width:100%;">
				...
				<tr>
					<td>No. Pembelian : ' . ($data['pembelian_kode'] ? $data['pembelian_kode'] : "-") . '</td>
			...
			foreach ($detail as $key => $value) {
				...
				$html .= '<tr>
						...
						<td>' . ($value['pembelian_detail_qty'] ? $value['pembelian_detail_qty'] * $value['barang_satuan_konversi']  : "-") . '</td>
