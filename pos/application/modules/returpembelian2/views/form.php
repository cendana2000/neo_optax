			...
			<form class="kt-form" action="javascript:save('form-returpembelianbarang')" name="form-returpembelianbarang" id="form-returpembelianbarang">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<input class="form-control" type="text" id="retur_pembelian_kode" name="retur_pembelian_kode" placeholder="##.AUTO">
						</div>
					</div>
					<div class="form-group row">
						...
						<!-- <div class="col-md-4">
							<div class="input-group">
								<input class="form-control" type="text" id="supplier_nama" name="supplier_nama" disabled="">
								<div class="input-group-append"><span class="input-group-text" id="supplier_telp">No. Telp</span></div>
							</div>
						</div> -->
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<!-- <input type="hidden" name="retur_pembelian_supplier_id" id="retur_pembelian_supplier_id"> -->
					...
					<div class="form-group row">
						<div class="col-md-4">
							<button type="button" class="btn btn-primary" onclick="listBarang()"><i class="flaticon-add"></i> Daftar Pembelian Barang</button>
						</div>
					</div>
							...
							<tbody>
								<tr class="barang barang_1" data-id="1">
									<td scope="row">
										...
										<select class="form-control" name="retur_pembelian_detail_barang_id[1]" id="retur_pembelian_detail_barang_id_1" style="width: 100%" data-id="1" onchange="setSatuan('1')"></select>
									</td>
									<td>
