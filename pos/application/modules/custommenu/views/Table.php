		...
		<div class="card card-custom">
			<div class="card-header">
				<div class="card-title">
					...
					<h3 class="card-label">FORM CUSTOM MENU</h3>
				</div>
			</div>
			<form action="javascript:save('form-custom-menu')" method="post" id="form-custom-menu" name="form-custom-menu" autocomplete="off">
				<div class="card-body">
					<div class="row">
						<div class="col">
							<input type="hidden" name="custom_menu_id">
							<div class="form-group row">
								<label class="col-lg-4 col-form-label text-left" for="custom_menu_nama">Nama Menu</label>
								<div class="col-lg-8">
									<input type="text" name="custom_menu_nama" class="form-control custom_menu_nama" placeholder="Nama Custom Menu">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-4 col-form-label text-left" for="custom_menu_harga">Harga</label>
								<div class="col-lg-8">
									<input type="number" name="custom_menu_harga" class="form-control custom_menu_harga" placeholder="Harga Custom Menu">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="card card-custom">
			<div class="card-header">
				<div class="card-title">
					...
					<h3 class="card-label">DATA CUSTOM MENU</h3>
				</div>
			...
			<div class="card-body table-responsive">
				<table class="table table-head-custom table-head-bg table-borderless table-vertical-center table-hover" id="table-custom-menu">
					<thead>
						<tr>
		...
		<div class="modal-content">
			...
			<form action="javascript:upload('form-import')" method="post" id="form-import" name="form-import" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="modal-footer">
					...
					<a href="<?= base_url('assets/laporan/menu/menu_template.xlsx'); ?>" class="btn btn-success"><span class="fas fa-download"></span> Download Template</a>
