	...
	<form class="kt-form" action="javascript:save('form-barang')" name="form-barang" id="form-barang">
		...
		<div class="kt-portlet__body">
			...
			<div class="form-group row">
				...
				<div class="col-3">
					<input class="form-control" type="text" id="barang_nama" name="barang_nama" placeholder="Nama Produk">
				</div>
				...
				<table class="table table-bordered table-hover" id="table-sales">
					...
					<tbody>
						<tr class="detail_1">
							...
							<td>
								<a href="javascript:;" data-id="1" class="btn btn-sm btn-clean btn-icon btn-icon-md kt-font-bold kt-font-warning" id="resetdetail1" onclick="remRow()" title="Reset">
