...
// $config['base_url']	= 'https://pmu-pttimah.sekawanmedia.co.id/panel/';
...
$config['sess_cookie_name'] = 'ci_session_bor';
...
$config['csrf_token_name'] = 'csrf_pajak';
$config['csrf_cookie_name'] = 'csrf_cookie_pajak';
