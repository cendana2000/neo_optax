...
class BASE_Controller extends MX_Controller
{
    ...
    public function select_dt($client, $modelname, $vmode = null, $serialNumber = false, $filterQuery = null, $filterRecord = null, $dbname = null, $group_by = null)
    {
        ...
        return
            array(
                ...
                // "sql" => $ssp_data["sql"],
                "modelname" => $modelname,
                "vmode" => $this->$modelname->get_view_mode($vmode),
                "column" => $columns
            );
    }
    ...
    // }
    public function response($operation = array(), $statuscode = 200)
    {
        if (empty($operation)) {
            $operation = array('success' => false);
        }
    ...
    public function sendFcm($ids, $data, $type = 'mobile')
    {
        ...
        $message['icon']         = base_url() . 'assets/media/logo.png';
