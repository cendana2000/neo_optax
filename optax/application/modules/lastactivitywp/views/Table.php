		...
		<div class="card card-custom">
			...
			<div class="card-body">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<li class="nav-item" role="presentation">
						<button class="nav-link" id="close-tab" data-toggle="tab" data-target="#close" type="button" role="tab" aria-controls="close" aria-selected="false">Close <span class="badge badge-dark ml-2 close-counter">0</span></button>
					</li>
					<li class="nav-item" role="presentation">
				...
				<div class="tab-content mt-5" id="myTabContent">
					<div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
						<div class="table-responsive">
							<table class="table table-checkable table-condensed" id="table-lastactivitywp-active" style="width: 100%">
								<thead>
									<tr>
								...
								<tbody>
									<tr class="no-list">
										<td colspan="6" class="text-center">Price List Tidak Tersedia</td>
									</tr>
								</tbody>
								<tfoot>
									<tr>
					...
					<div class="tab-pane fade" id="inactive" role="tabpanel" aria-labelledby="inactive-tab">
						<div class="table-responsive">
							<table class="table table-checkable table-condensed" id="table-lastactivitywp-inactive" style="width: 100%">
								<thead>
									<tr>
										<th style="width:5%;">No.</th>
										<th>Kode Toko</th>
					...
					<div class="tab-pane fade" id="offline" role="tabpanel" aria-labelledby="offline-tab">
						<div class="table-responsive">
							<table class="table table-checkable table-condensed" id="table-lastactivitywp-offline" style="width: 100%">
								<thead>
									<tr>
										<th style="width:5%;">No.</th>
										<th>Kode Toko</th>
					...
					<div class="tab-pane fade" id="close" role="tabpanel" aria-labelledby="close-tab">
						<div class="table-responsive">
							<table class="table table-checkable table-condensed" id="table-lastactivitywp-close" style="width: 100%">
								<thead>
									<tr>
										<th style="width:5%;">No.</th>
										<th>Kode Toko</th>
					...
					<div class="tab-pane fade" id="all" role="tabpanel" aria-labelledby="all-tab">
						<div class="table-responsive">
							<table class="table table-checkable table-condensed" id="table-lastactivitywp-all" style="width: 100%">
								<thead>
									<tr>
										<th style="width:5%;">No.</th>
										<th>Kode Toko</th>
		...
		<div class="card card-custom">
			...
			<div class="card-body table-responsive">
				<div class="kt-portlet kt-portlet--mobile ">
					...
					<div class="kt-form">
						<div class="kt-portlet__body form" id="pdf-laporan-lastactivitywp">
							<object data="" type="application/pdf" width="100%" height="500px"></object>
						</div>
					</div>
				</div>
