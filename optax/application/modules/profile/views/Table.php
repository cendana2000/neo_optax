				...
				<div class="card card-custom">
					...
					<div class="card-body pt-4">
						...
						<div class="d-flex align-items-center">
							...
							<div>
								<span class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary show-nama">-</span>
								<div class="text-muted show-hak_akses">-</div>
							</div>
						</div>
						<!--end::User-->
						<!--begin::Contact-->
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group row my-2">
														...
														<div class="col-8">
															<span class="form-control-plaintext font-weight-bolder detail-email"></span>
														</div>
													</div>
													<div class="form-group row my-2">
