...
<head>
	<base href="">
	<meta charset="utf-8" />
	<title>Wajib Pajak | <?= $this->config->item('app_title') ?></title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		...
		<a href="<?= base_url(); ?>">
			...
			<h2 class="text-white">WAJIB PAJAK</h2>
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
						...
						<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
							...
							<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default align-items-center">
								<div class="dropdown dropdown-inline" data-toggle="tooltip" data-placement="left">
									<span class="menu-text font-weight-bold">WAJIB PAJAK</span>
								</div>
						...
						<div class="topbar">
							...
							<div class="topbar-item">
								<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
									...
									<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?= $this->session->userdata('wajibpajak_nama_penanggungjawab') ?></span>
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="d-flex align-items-center mt-5">
				<div class="symbol symbol-100 mr-5">
					<?php
					$user_foto = $this->session->userdata('wajibpajak_foto');
					if ($user_foto) {
				...
				<div class="d-flex flex-column">
					<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?= $this->session->userdata('wajibpajak_nama_penanggungjawab') ?></a>
					<div class="navi mt-2">
			...
			<div class="navi navi-spacer-x-0 p-0">
				<!-- <a target="_blank" href="<?= base_url('/assets/manualbook/Manual_Book_Aplikasi_Tax_System_(Wajib_Pajak)_25_Jan_2023.pdf') ?>" class="navi-item" download="manualbook">
					<div class="navi-link">
	...
	<?php load_view('mitra/JavascriptMitra') ?>
	<?php load_view('mitra/JavascriptNotif') ?>
	<?php if ($this->session->flashdata('data_wp')) : ?>
		...
		<script>
			...
			//<?php print_r($this->session->flashdata("data_wp")["konfirmasi_result"]); ?>
