<script type="text/javascript">
  ...
  function showNotifBelumDibaca() {
		...
		HELPER.initLoadMore({
			perPage: 20,
			urlExist: BASE_URL + 'mitra/notifBelumDibacaExist',
			dataExist: null,
			urlMore: BASE_URL + 'mitra/notifBelumDibacaMore',
			dataMore: null,
	...
	function showNotifDibaca() {
		...
		HELPER.initLoadMore({
			perPage: 20,
			urlExist: BASE_URL + 'mitra/notifDibacaExist',
			dataExist: null,
			urlMore: BASE_URL + 'mitra/notifDibacaMore',
			dataMore: null,
			callbackExist: function(data) {
				if (data.hasOwnProperty('success')) {
  ...
  function setReadNotif(idd) {
		HELPER.ajax({
			url: BASE_URL + 'mitra/setReadNotif',
			data: {
				id: idd
			}
		})
