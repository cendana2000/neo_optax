			...
			<form class="kt-form" action="javascript:save('form-pembayaran', '1')" name="form-pembayaran" id="form-pembayaran">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input class="form-control" type="text" id="pembayaran_kode" name="pembayaran_kode" readonly="" placeholder="##.AUTO">
						</div>
						<div class="col-1"></div>
						...
						<table class="table table-bordered table-hover" id="table-detail_beli">
							...
							<tfoot style="display: none">
								<tr>
									...
									<td class="no-border"><input class="form-control number" type="text" id="pembayaran_tagihan" name="pembayaran_tagihan" readonly=""></td>
									<td class="no-border"><input class="form-control number" type="text" id="pembayaran_retur" name="pembayaran_retur"></td>
									<td class="no-border"><input class="form-control number" type="text" id="pembayaran_potongan" name="pembayaran_potongan" readonly=""></td>
									<td class="no-border"><input class="form-control number" type="text" id="pembayaran_sisa" name="pembayaran_sisa" readonly=""></td>
									<td class="no-border"><input class="form-control number" type="text" id="pembayaran_bayar" name="pembayaran_bayar" readonly=""></td>
