			...
			<form action="javascript:getLaporan()" name="laporan_survey" id="laporan_survey">
				<div class="card-body table-responsive">
					<div class="form-group row">
						<label for="jenis_retur" class="col-lg-2 col-sm-12 col-form-label">Survey</label>
					...
					<div class="form-group row">
						<label for="jenis_retur" class="col-lg-2 col-sm-12 col-form-label">Jenis Laporan</label>
						<div class="col-lg-10 col-sm-12">
