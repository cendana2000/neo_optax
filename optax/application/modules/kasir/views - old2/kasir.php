...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-footer--fixed  kt-aside-secondary--enabled kt-page--loading kt-aside-secondary--expanded">
								...
								<div class="kt-header__topbar-item kt-header__topbar-item--user" style="margin-right: 10px">
									...
									<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-sm">
										...
										<ul class="kt-nav kt-margin-b-10">
											...
											<li class="kt-nav__item">
												<a href="javascript:void(0)" onclick="onPesanan()" class="kt-nav__link">
													<span class="kt-nav__link-icon"><i class="fas fa-money-check"></i></span>
													<span class="kt-nav__link-text">Pesanan Masuk (<span style="color:red;" class="notif"></span>)</span>
												</a>
											</li>
											<li class="kt-nav__item">
		...
		<div class="modal bd-example-modal-xl fade" id="modal-pesanan" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-xl"  role="document" style="width: 1250px">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="padding-top: 10px;" id="exampleModalCenterTitle">Pesanan Masuk</h5>			
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
		...
		<div class="modal bd-example-modal-xl fade" id="modal-daftar-pesanan" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-xl"  role="document" style="width: 1250px">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="padding-top: 10px;" id="exampleModalCenterTitle">Daftar Pesanan</h5>			
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">						
						...
						<div id="button-proses"></div>
						<button class="btn btn-danger float-right btn-sm mr-4" onclick="onCancelModal()">Kembali</button>
					</div>
				</div>
			</div>
		</div>
		...
		<script src="<?php echo base_url() ?>appjs/fcm.js" type="text/javascript"></script>
		...
		<script>
			...
			FCM.setConfig({
				apiKey: "AIzaSyA_wTn5AXgKr71DooClhEIPmUHb_xY6oWw",
				authDomain: "kpri-eko-kapti.firebaseapp.com",
				databaseURL: "https://kpri-eko-kapti.firebaseio.com",
				projectId: "kpri-eko-kapti",
				storageBucket: "kpri-eko-kapti.appspot.com",
				messagingSenderId: "705584251831",
				appId: "1:705584251831:web:747087b6f98d70433dde32",
				measurementId: "G-DEQT445YFT",
			});
