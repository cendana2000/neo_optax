		...
		<div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid wizard" id="kt_login">
					...
					<div class="login-form">
						...
						<form class="form px-10" action="javascript:void(0)" novalidate="novalidate" id="kt_login_signin_form" autocomplete='off'>
							...
							<div class="d-flex justify-content-between pt-7">
								<div>
									<!-- <button class="btn btn-primary btn-sm font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3 d-none" data-wizard-type="action-submit" type="submit" id="kt_login_signup_form_submit_button">Submit</button> -->
									<!-- <button type="button" class="btn btn-primary btn-sm font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" data-wizard-type="action-next">Next -->
									<button type="button" class="btn btn-primary btn-sm font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3 btn-next" onclick="doLogin()">Login</button>
								</div>
							</div>
							<!--end: Wizard Actions-->
						</form>
			...
			<div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
				<div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom" style="background-image: url(assets/media/svg/illustrations/login-visual-4.svg);">
					<!--begin::Aside title-->
					<h3 class="pt-lg-30 pl-lg-20 pb-lg-0 pl-10 py-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-lg text-white">POS Management System</h3>
					<!--end::Aside title-->
				</div>
			</div>
			<!--end::Aside-->
