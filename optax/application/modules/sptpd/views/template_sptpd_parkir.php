      ...
      <tr>
        ...
        <td colspan="5" style="font-size: 11px; width: 40%">
          <ul style="list-style-type: none; margin-left: -30px">
            <li>No. SPTPD : 1241241412</li>
            <li>Masa Pajak : 12414124</li>
            <li>Tahun Pajak : 12412412</li>
          </ul>
        </td>
      </tr>
      <!-- batas -->
          ...
          <ol>
            ...
            <li style="margin-top: 10px">
              <div style="margin-bottom: 10px">
                Tarif dan jumlah kendaraan yang parkir :
              </div>
              <div>
                <table>
                  <tr>
      ...
      <tr>
        <td colspan="12">
          <ol>
            <li>
              <div style="margin-bottom: 15px">
                Jumlah dan Pajak Terutang untuk masa pajak sebelumnya (akumulasi
                dari awal masa pajak dalam Tahun Pajak Tertentu) :
              </div>
              <div>
                <table style="border: none">
                  <tr>
