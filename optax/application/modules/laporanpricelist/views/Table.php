	...
	<div class="col-12">
		<div class="card card-custom">
			...
			<div class="card-title">
					...
					<h3 class="card-label">PRICE LIST</h3>
				</div>		
			</div>
          ...
          <div id="next-action" style="display: none;">
            <div class="row kt-margin-b-10">
              <div class="col-2">
                <label class="text-dark" for="barang_kategori_barang">Pilih Berdasarkan</label>
              ...
              <div class="col-4 kategori">
                <label class="text-dark" for="barang_kategori_barang">Kelompok Barang</label>
              ...
              <div class="col-4 barang">
                <label class="text-dark" for="barang_id">Barang</label>
			...
			<div class="card-body table-responsive">
				<table class="table table-checkable table-condensed" id="table-pricelist" style="width: 100%">
					...
					<tbody>
						<tr class="no-list">
							<td colspan="10" class="text-center">Price List Tidak Tersedia</td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
