...
<div class="row">
		...
		<div class="card card-custom">
			<div class="card-header card-header-right ribbon ribbon-clip ribbon-left">
				<div class="ribbon-target" style="top: 12px;">
					<span class="ribbon-inner bg-primary"></span>Form Default
				</div>
			</div>
					...
					<div class="row">
						<div class="col">
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" name="satuan_kode" class="form-control satuan_kode" placeholder="Satuan" required minlength="2" maxlength="150">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-lg-4 col-form-label text-left" for="satuan_kode">Keterangan</label>
								<div class="col-lg-8">
									<input type="text" name="satuan_nama" class="form-control satuan_nama" placeholder="Keterangan" required minlength="2" maxlength="150">
								</div>
							</div>
						</div>
					</div>
	...
	<div class="col">
		<div class="card card-custom">
			<div class="card-header card-header-right ribbon ribbon-clip ribbon-left">
				<div class="ribbon-target" style="top: 12px;">
					<span class="ribbon-inner bg-primary"></span>Data Default
				</div>
