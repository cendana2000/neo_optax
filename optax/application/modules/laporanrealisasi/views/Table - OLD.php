					...
					<div class="kt-form">
						<div class="kt-portlet__body">
							<div class="form-group row">
								...
								<label for="tanggal" class="col-2 col-form-label tanggal">Tanggal</label>
							...
							<div class="form-group row">
								<label for="laporan" class="col-2 col-form-label">Sektor Usaha</label>
								<div class="col-3">
							...
							<div class="form-group row">
								<div class="col-2"></div>
								<div class="col-10">
									<button type="submit" class="btn btn-info"><i class="far fa-file-alt"></i> Rincian</button>
									<button type="button" class="btn btn-info" onclick="getLaporanRekap()"><i class="far fa-file-alt"></i> Rekapan</button>
									<button type="button" onclick="getLaporanRekapExcelRI()" id="btn-excel" class="btn btn-success"><i class="far fa-file-excel"></i> Rincian</button>
									<button type="button" onclick="getLaporanRekapExcelRE()" id="btn-excel" class="btn btn-success"><i class="far fa-file-excel"></i> Rekapan</button>
								</div>
							</div>
						</div>
					</div>
