<div class="card card-custom card-stretch ">
    ...
    <div class="card-header py-3">
        <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">Registrasi Tempat Usaha</h3>
            <span class="text-muted font-weight-bold font-size-sm mt-1">Detail Informasi Registrasi Tempat Usaha</span>
        </div>
        <div class="card-toolbar">
            <!-- <button type="submit" onclick="updateDataMitra('form-mitra-usaha')" id="btnSaveChanges" class="btn btn-success mr-2 profil_update" style="display: none;"><i class="fas fa-paper-plane"></i>Simpan Perubahan</button> -->
        </div>
    </div>
    <!--end::Header-->
    <!--begin::Form-->
    ...
    <div class="card-body table_data">
        <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
            ...
            <div class="alert-text">
                <h4 class="alert-heading">Usaha.</h4>
                <p class="my-5">Anda dapat meregistrasikan Tempat usaha untuk transaksi usaha anda silahkan klik tombol dibawah ini. Untuk informasi lebih lanjut bisa menghubungi
                    <a class="font-weight-bold" href="https://getbootstrap.com/docs/4.6/components/alerts/" target="_blank">ADMIN OPTAX</a>.
                </p>
                <div class="border-bottom border-dark opacity-10 mb-5"></div>
                <button type="button" name="btn-registrasi" class="btn btn-success btn-sm mr-3" onclick="showToko()">Registrasi Tempat Usaha</button>
            </div>
        </div>
    </div>

    <!--begin::Body-->
    <form class="form" method="POST" name="form-toko" id="form-toko" action="javascript:save('form-toko')" type="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <h5 class="font-weight-bold mb-6">Informasi Tempat Usaha</h5>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="image-input image-input-outline" id="kt_profile_avatar">
                                <div class="image-input-wrapper show-mitra-image" style="background-image: url(&quot;<?= base_url() ?>/assets/media/noimage.png&quot;);"></div>
                                <label onchange="onChangeImage(this)" id="label-changeimage" class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                    <i class="fa fa-pen icon-sm text-muted"></i>
                                    <input class="is_edit_picture" id="logo_toko" type="file" name="logo_toko" accept=".png, .jpg, .jpeg">
        ...
        <div class="card-footer" id="footer-insert" style="display: none;">
            <div class="row">
    ...
    <div class="card-footer text-right" id="footer-update" style="display: none;">
        <button type="button" class="btn btn-sm btn-success" onclick="handleUpdate()"><i class="fas fa-save"></i> Submit</button>
    </div>
    <!--end::Body-->
</div>
