...
class RealisasipajakdetailModel extends Base_Model
{
        ...
        $model = array(
            'table' => array(
                ...
                'fields' => array(
                    ...
                    array('name' => 'realisasi_detail_total_pajak', 'view' => true),
                )
            ),
            'view' => array(
                'name' => 'v_realisasi_detail',
                'mode' => array(
                    'table' => array(
                        'realisasi_detail_id',
